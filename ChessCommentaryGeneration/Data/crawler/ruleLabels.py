...
# Single-Word Rules
rules = {}
rules[QUALITY] = ["solid", "excellent", "blunder", "error", "fortunately", "nice", "unwise", "good", "bad", "disaster",
                  "mistake", "disastrous", "blunderous", "blunder", "premature", "reasonable", "weak", "strong"]
rules[QUALITY] += ["blundered", "lame", "terrible", "horrible", "flexible", "pretty"]
rules[ALTERNATE] = ["considering", "better", "inclined", "possible", "possibility", "alternately", "alternative", "if",
                    "going"]
rules[EXPECTED] = ["curious", "conventionally", "logical", "surprise", "surprising", "typical", "atypical", "expected",
                   "unexpected", "standard", "odd", "strange", "unusual", "forced", "Out", "inevitable"]
rules[LONG_TERM] = ["hopeful", "need", "later", "important", "critical", "advantage", "decisive", "going", "preparing",
                    "prospects", "inevitable", "probably", "offer", "analyzing", "otherwise"]
rules[STATE] = ["feeling", "believe", "points", "edge", "pressure"]
rules[DESCRIBE] = ["removes", "retreats", "blocks", "Moving", "takes", "plays", "protects", "forks", "repositions",
                   "brings", "bring"]
rules[DESCRIBE] += ["moves", "attacks", "defends", "captures", "sacrifices", "blocks", "attacking", "castles",
                    "defending", "took", "decides", "standard", "chose", "chosen", "prefer", "prefers"]
rules[OTHERS] = []
# Multi-word rules
multiRules = {}
multiRules[QUALITY] = []
