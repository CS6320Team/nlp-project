...
def main(src_dir, src, typ="threat"):
    ...
    for line in che_data:
        ...
        current_board, previous_board, from_position, to_position, current_player, other_player = parseChessString(
            chess_str)
        ...
        threat_feats = getThreatFeatures(cur_board, prev_board, current_player, other_player, from_position,
                                         to_position)
